...
public class GalleryAdapterBk extends BaseAdapter {
    ...
    private final GalleryFragmentBk galleryFragment;

    public GalleryAdapterBk(Context context, GalleryFragmentBk galleryFragment) {
