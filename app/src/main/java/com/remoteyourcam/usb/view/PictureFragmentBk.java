...
public class PictureFragmentBk extends SessionFragmentBk implements Camera.RetrieveImageListener, GestureHandler {

    public static PictureFragmentBk newInstance(int objectHandle) {
        Bundle args = new Bundle();
        args.putInt("handle", objectHandle);
        PictureFragmentBk f = new PictureFragmentBk();
        f.setArguments(args);
        return f;
    }
