...
import com.remoteyourcam.usb.view.GalleryFragmentBk;
...
import com.remoteyourcam.usb.view.TabletSessionFragmentBk;
import com.remoteyourcam.usb.view.WebViewDialogFragment;

import java.io.File;

public class MainActivityBk extends SessionActivity implements CameraListener {
    ...
    private final String TAG = MainActivityBk.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bar.addTab(bar.newTab().setText("Session").setTabListener(new MyTabListener(new TabletSessionFragmentBk())));
        bar.addTab(bar.newTab().setText("Gallery").setTabListener(new MyTabListener(new GalleryFragmentBk())));
        ...
        Thread th = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                handler.post(new Runnable() {
                    @Override
                    public void run() {
                        MainActivityBk.this.dismissDialog(DIALOG_PROGRESS);
